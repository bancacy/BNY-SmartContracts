/*
  ...
  * We double the total equilibriums supply.
...
let uEquilibriums, preRebaseSupply, postRebaseSupply;
...
async function exec () {
  ...
  do {
    ...
    await uEquilibriums.rebase(2 * i, 1, {from: deployer});
    postRebaseSupply = await uEquilibriums.totalSupply.call();
    console.log('Rebased by 1 BNY');
    ...
    await uEquilibriums.rebase(2 * i + 1, postRebaseSupply, {from: deployer});
    i++;
  } while ((await uEquilibriums.totalSupply.call()).lt(endSupply));
}
